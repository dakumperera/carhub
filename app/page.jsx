...
import CarCard from "@/components/car-card"; // ← Changed from named to default import
import HomeSearch from "@/components/home-search"; // ← Changed from named to default import
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <h1 className="text-5xl md:text-8xl mb-4 gradient-title">
              Find your Dream Car with Carhub AI
            </h1>
