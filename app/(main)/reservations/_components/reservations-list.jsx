...
export function ReservationsList({ initialData }) {
  // Add local state to manage bookings
  ...
  // Handle cancellation with state update
  const handleCancelBooking = async (bookingId) => {
    try {
      ...
      console.log("✅ Booking cancelled and UI updated");
    } catch (error) {
      console.error("❌ Failed to cancel booking:", error);
    }
  };

  // Group bookings by status using the local state
